  ...
  return (
    ...
    >
      ...
      <div className="flex items-center justify-between px-4 py-5 border-b border-cream/10">
        {!collapsed && (
          <span className="font-serif text-lg text-cream">Pierre G.</span>
        )}
        <button
          onClick={() => setCollapsed(!collapsed)}
          className="text-cream/40 hover:text-cream transition-colors p-1 ml-auto"
          ...
          <Link
            ...
            className={`flex items-center gap-3 px-4 py-2.5 text-sm transition-colors ${
              isActive(item.href, item.exact)
                ? "bg-moss/20 text-cream border-r-2 border-moss"
      ...
      <div className="border-t border-cream/10 p-4">
        <a
          ...
          className={`flex items-center gap-3 text-cream/30 hover:text-cream/60 transition-colors text-xs`}
